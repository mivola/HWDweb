...
$play_str = "SELECT g.play AS play, max(g.p_ts) AS p_ts FROM ".$season."_tbl_play p, ".$season."_tbl_game g WHERE p.id=g.play AND p.recorded > 0 AND completed = 0 AND season=".$season." AND g.play=2 GROUP BY g.play";
