...
$initStr = "SELECT u.email AS mail, t.name AS team_name FROM tbl_user u, tbl_extra_wins ew, tbl_team t WHERE ew.userID=".$act_userid." AND u.ID=ew.userID AND t.id=ew.";
