...
$str = "SELECT * FROM ".$season."_tbl_extra_wins ew WHERE ew.userID=0";
//echo $str."<br>";
...
//echo $str;
$result = mysql_query($str);
$str = "INSERT INTO ".$season."_tbl_extra_wins values ($act_userid, $season, $champ, $second, $third, $forth, $fifth, $down1, $down2, $down3, $up1, $up2, $up3, $fired, $fired2, $wins)";
//echo $str;
