...
// select * from tbl_game AS g, tbl_team AS t1, tbl_team AS t2 where g.play=1 and t1.id=g.team1 and t2.id=g.team2
...
if (isset($free)) {
  ...
  echo "<br>Dieser Spieltag wurde freigegeben. Tipps können jetzt eingegeben werden.<br>";
