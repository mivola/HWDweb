...
//session_register("new_user_id");

require("connect_db.php");

$bets1=1;
// mit bet: Select * from tbl_game g, tbl_team1 t1, tbl_team2 t2, tbl_bet b where play=1 and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 and b.game=g.id
$resultPlayBL1 = mysql_query("Select * from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2, tbl_bet b where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 and b.game=g.id and b.userID=".$new_user_id." order by g.id");
// SELECT g.id, g.p_ts, t1.name, t2.name2, b.bet1, g.bet2 FROM tbl_game g, tbl_team1 t1, tbl_team2 t2, tbl_bet b where g.play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 and b.game=g.id order by g.id
if (mysql_num_rows($resultPlayBL1) < 9) {
//if (mysql_num_rows($resultPlayBL1) == 0) {
  $bets1=0;
  // SELECT g.id, g.p_ts, t1.name, t2.name2 FROM tbl_game g, tbl_team1 t1, tbl_team2 t2 where g.play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 order by g.id
...
$bets2=1;
$resultPlayBL2 = mysql_query("Select * from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2, tbl_bet b where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2 and b.game=g.id and b.userID=".$new_user_id." order by g.id");
if (mysql_num_rows($resultPlayBL2) == 0) {
  $bets2=0;
  $resultPlayBL2 = mysql_query("Select * from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2 order by g.id");
}

//$resultPlayBL1 = mysql_query("Select * from tbl_game g, tbl_team1 t1, tbl_team2 t2, tbl_bet b where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2 and b.game=g.id");
//$resultPlayBL2 = mysql_query("Select * from tbl_game g, tbl_team1 t1, tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2");
