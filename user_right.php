...
<?php if($first_name == ""){ ?>
	...
	- mit einem rechten Mausklick auf den Eintrag "http://mivola.mi.funpic.de/hwd14_15" das Kontextmen&uuml; &ouml;ffnen<br>
...
<?php } else { //if ?>
	...
	Herzlich willkommen bei der Online-Version von HWD zur Saison 2014/2015.</b>
	<br><br><br>
	Wie gewohnt steht euch rechtzeitig die neue Tippseite zur Verfügung. Wir begrüßen unseren neuen Mitspieler "Schrö" mit einem kräftigen "Tipp Frei!" :-)<br>
	<br />
	Die Tipps der vergangenen Saison gibt es <a href="http://hwd.bts-computer.de/hwd13_14" target="_blank">hier</a>.<br /> 
	<br />
