...
<?php } else { //if ?>
	...
	Herzlich willkommen bei der Online-Version von HWD zur Saison 2009/2010.</b>
	<br><br><br>
	Hiermit ist die neue Saison eröffnet! Ich wünsche allen wie immer viel Spass und Erfolg in der neuen Saison!<br>
	Wenn ihr euch nochmal die Ergebnisse und Tipps der letzten Saison anschauen wollt, dann gibt es das <a href="http://hwd.bts-computer.de/hwd08_09" target="_blank">hier</a>
	</p>
	<br>
	<br>
	<br>
