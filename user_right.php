...
<?php } else { //if ?>
	...
	Herzlich willkommen bei der Online-Version von HWD zur Saison 2013/2014.</b>
	<br><br><br>
	Kurz vor der Panik ist nun endlich auch die aktuelle Saison eröffnet! Hoffen wir mal dass sich die technischen Probleme in Grenzen halten und Nico zumindest hart kämpfen muss um seinen Titel zu verteidigen!<br>
	<br />
	Die Tipps der vergangenen Saison gibt es <a href="http://hwd.bts-computer.de/hwd11_12" target="_blank">hier</a>.<br /> 
	<br />
