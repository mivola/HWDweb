...
<?php } else { //if ?>
	...
	Herzlich willkommen bei der Online-Version von HWD zur Saison 2007/2008.</b>
	<br><br><br>
	Ich wünsche allen und vor allem unseren 2 "Neuen" viel Spass und Erfolg in der neuen Saison!<br>
	Wenn ihr euch nochmal die Ergebnisse und Tipps der letzten Saison anschauen wollt, dann gibt es das <a href="http://hwd.bts-computer.de/hwd06_07" target="_blank">hier</a>
	</p>
	<br>
	<br>
	<br>
