...
for ($i=1; $i <= $maxi; $i++){
  ...
  if ($bet1 == "") { $bet1 = "-1"; }
  if ($bet2 == "") { $bet2 = "-1"; }
  $result1 = mysql_query("DELETE FROM ".$season."_tbl_bet WHERE game=".$game." AND userID=".$act_userid);
  $query = "INSERT INTO ".$season."_tbl_bet (userID, game, bet1, bet2, bet_ts) VALUES (".$act_userid.", ".$game.", ".$bet1.", ".$bet2.", ".time().")";
...
// save joker1  
$queryJoker = "UPDATE ".$season."_tbl_bet SET joker1=1 WHERE userID=".$act_userid." AND game=".$joker1.";";
...
$resultPlayBL1 = mysql_query("Select * from ".$season."_tbl_bet b, ".$season."_tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2, ".$season."_tbl_user u where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 and b.game=g.id and b.userID=".$act_userid." and u.id=".$act_userid." order by g.p_ts, g.id");
$resultPlayBL2 = mysql_query("Select * from ".$season."_tbl_bet b, ".$season."_tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2 and b.game=g.id and b.userID=".$act_userid." order by g.p_ts, g.id");
...
<?PHP
  ...
  $subject = "HWD: deine Tipps wurden gespeichert";
