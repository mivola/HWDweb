...
$result = mysql_query("SELECT password, email FROM ".$season."_tbl_user WHERE nick_name='".$name."'");
//echo "SELECT password, email FROM ".$season."_tbl_user WHERE nick_name='".$name."'";
