...
$result = mysql_query("SELECT password, email FROM tbl_user WHERE nick_name='".$_REQUEST[name]."'");
...
if ( isset($email) ) {
  ...
  echo "<font size=4 color=red>Der eingegebene Username ($_REQUEST[name]) ist nicht bekannt!</font><br><br>";
}
