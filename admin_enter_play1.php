...
$resultPlayBL1 = mysql_query("Select t1.id, t2.id2, g.p_ts from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 order by g.id");
$stringResultPlayBL1 = "Select t1.id, t2.id2, g.p_ts from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=1 order by g.id";
...
$resultPlayBL2 = mysql_query("Select t1.id, t2.id2, g.p_ts from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2 order by g.p_ts, g.id");
$stringResultPlayBL2 = "Select t1.id, t2.id2, g.p_ts from tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 where play=".$play." and t1.id=g.team1 and t2.id2=g.team2 and t1.league=2 order by g.id";
...
<input name=playID type=hidden value=<?PHP echo $play ?>>
  <table border="0">
    ...
    <font size=3><a href="http://www.dfb.de/bliga/bundes/archiv/2003/spieltage/bs1m<?PHP echo $play ?>.html" target="_blank">zur DFB-Seite</a></font>
    </td></tr>
...
?>
    ...
    <font size=3><a href="http://www.dfb.de/bliga/2bundes/archiv/2003/spieltage/bs2m<?PHP echo $play ?>.html" target="_blank">zur DFB-Seite</a>
    </td></tr>    
    <tr style="background-color:<?PHP echo $table_head; ?>;">
      <td valign=top><b>SpNr.</b></td>
      <td valign=top><b>&uuml;ber-<br>nehmen</b></td>
