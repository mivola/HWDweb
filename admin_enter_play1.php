...
<input name=playID type=hidden value=<?PHP echo $play ?>>
  <table border="0">
    ...
    <font size=3><a href="http://www.dfb.de/bliga/spiel.php?liga=bl1m&spieltag=<?PHP echo $play ?>&art=e&saison=04&saisonl=2004&lang=D" target="_blank">zur DFB-Seite</a></font>
    </td></tr>
...
?>
    ...
    <font size=3><a href="http://www.dfb.de/bliga/spiel.php?liga=bl2m&spieltag=<?PHP echo $play ?>&art=e&saison=04&saisonl=2004&lang=D" target="_blank">zur DFB-Seite</a>
    </td></tr>    
    <tr style="background-color:<?PHP echo $table_head; ?>;">
      <td valign=top><b>SpNr.</b></td>
      <td valign=top><b>&uuml;ber-<br>nehmen</b></td>
