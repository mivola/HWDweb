  ...
  <table border="0">
    <tr>
    	<td colspan=6><b>1. Bundesliga</b><br>
    		<a href="https://www.dfb.de/bundesliga/spieltagtabelle/?spieledb_path=%2Fde%2Fcompetitions%2Fbundesliga%2Fseasons%2F20<?PHP echo $season ?>-20<?PHP echo $season+1 ?>%2Fmatchday%2F<?PHP echo $play ?>" target="_blank">zur DFB-Seite</a>
    		|
    		<a href="https://www.unixtimestamp.com/" target="_blank">Timestamp Generator</a>
    	</td>
    </tr>
...
<?PHP
  ...
  for ($j=1; $j<=9; $j++){
    ...
    if ($j == 1) {
      ...
      echo "<td><a href=# onClick=".$javastr.">fÃ¼r alle</a></td>";
...
?>
    ...
    <tr>
    	<td colspan=4><br><b>2. Bundesliga</b><br>
			<a href="https://www.dfb.de/2-bundesliga/spieltagtabelle/?spieledb_path=%2Fde%2Fcompetitions%2F2-bundesliga%2Fseasons%2F20<?PHP echo $season ?>-20<?PHP echo $season+1 ?>%2Fmatchday%2F<?PHP echo $play ?>" target="_blank">zur DFB-Seite</a>		    
	    </td>
    </tr>    
    <tr style="background-color:<?PHP echo $table_head; ?>;">
      <td valign=top><b>SpNr.</b></td>
