...
$joker1Set = 0;
$resultJoker = mysql_query("SELECT min(p_ts) as min FROM ".$season."_tbl_game g WHERE g.play=".$play);
...
<input name=playID type=hidden value=<?PHP echo $play ?>>
  <table>
    <tr><td colspan=6 class="noBorder"><b>1. Bundesliga</b><br>
        <font>na, wieder keine Ahnung was du tippen sollst? Schau doch mal bei <a href="http://www.betandwin.de/sportsmicrosite/betsframe/default.asp?page=homepage" target="_blank">bet&win.de</a> vorbei!<br>
...
<?PHP
  ...
  for ($j=1; $j<=9; $j++){
    ...
    else {// tipps können noch eingetragen werden
...
?>
    ...
    <tr><td colspan=4 class="noBorder"><br><b>2. Bundesliga</b><br>
        <font>Infos zur 2. Liga: <a href="http://www.sport1.de/coremedia/generator/www.sport1.de/Sportarten/Fussball/Bundesliga2/Main.html" target="_blank">Sport1.de</a> oder <a href="http://www.bundesliga.de/liga2/" target="_blank">bundesliga.de</a>.
        </font></td>
    </tr>
    <tr style="background-color:<?PHP echo $table_head; ?>;">
      <td valign=top><b>SpNr.</b></td>
