...
foreach($plays as $play) {
  ...
  $resultUsers = mysql_query("SELECT * FROM ".$season."_tbl_user u, ".$season."_tbl_points p, 5_tbl_wins w WHERE p.userID=u.id AND p.play=".$play." AND w.userID=u.id AND w.play=p.play ORDER BY u.id");
