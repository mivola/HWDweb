...
$resultPlays = mysql_query("SELECT id FROM tbl_play WHERE season=".$season." ORDER BY id");
$i = 1;
...
foreach($plays as $play) {
  ...
  $resultUsers = mysql_query("SELECT * FROM tbl_user u, tbl_points p WHERE p.userID=u.id AND p.play=".$play." ORDER BY u.id");
