...
//$resultPlayBL1 = mysql_query("SELECT g.id, t1.name, t2.name2, p_ts, result1, result2 from ".$season."_tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 WHERE play=".$_REQUEST[play]." AND t1.id=g.team1 AND t2.id2=g.team2 AND t1.league=1 ORDER BY g.id");
//$resultPlayBL2 = mysql_query("SELECT g.id, t1.name, t2.name2, p_ts, result1, result2 from ".$season."_tbl_game g, ".$season."_tbl_team1 t1, ".$season."_tbl_team2 t2 WHERE play=".$_REQUEST[play]." AND t1.id=g.team1 AND t2.id2=g.team2 AND t1.league=2 ORDER BY g.id");
$resultPlayBL1 = mysql_query($str_resultPlayBL1);
$resultPlayBL2 = mysql_query($str_resultPlayBL2);
...
echo "<body bgcolor=\"#000000\"><br><b>Tipps und Ergebnisse des ".$_REQUEST[play].". Spieltags:</b><br><br>";
