  ...
  if ($free > -1) {
    ...
    foreach ($users as $userid){
      ...
      if ($max_points == $points[$userid]){
        ...
        $query = "INSERT INTO ".$season."_tbl_wins (play, userID, wins) VALUES (".$play.", ".$userid.", $max_points4_win)";
        mysql_query($query);
      } else if ($max_points5 == $points[$userid]){
        $query = "INSERT INTO ".$season."_tbl_wins (play, userID, wins) VALUES (".$play.", ".$userid.", $max_points5_win)";
        mysql_query($query);
      } else {
...
//SELECT * FROM ".$season."_tbl_wins w WHERE play=".$play."
...
//check if $points[$userid]==$max_pointsX, than check if $max_pointsX_win
    ...
    //2.Platz
    if ( ($max_points2 == $points[$userid]) && ($max_points2 > 0) ){
    ...
    //3.Platz
    if ( ($max_points3 == $points[$userid]) && ($max_points3 > 0) ){
