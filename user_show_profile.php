...
while($row = mysql_fetch_array($result)) {
  ...
  echo "<tr><td>neues Passwort</td><td><input type=password name=pass1 maxlength=10 size=15></td></tr>";
  echo "<tr><td>neues Passwort</td><td><input type=password name=pass2 maxlength=10 size=15></td></tr>";
